 ...
 * Mar.25.2005 * Description: Class that calculates the value of the
 * combination: C(n,k).          
 *
 */
...
public class BinomialCoefficients {
	 ...
	 * Ozan
     */
    private static HashMap<Integer, HashMap<Integer, BigInteger>> results = new HashMap<Integer, HashMap<Integer, BigInteger>>();
    ...
    public BigInteger calculateBinomialCoefficients(int nInput, int kInput) {
        ...
        HashMap<Integer, BigInteger> mapLvl2 = results.get(nInput);
        if (mapLvl2 == null) {
            results.put(nInput, new HashMap<Integer, BigInteger>());
        } else {
            product = mapLvl2.get(kInput);
        }
        ...
        if (product == null) {
            ...
            results.get(nInput).put(kInput, product);
        }
        return product;
    }
